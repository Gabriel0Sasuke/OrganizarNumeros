...
namespace OrganizarNumeros
{
    ...
    {
        int contador = 0;
        private readonly int[,] board = new int[5, 5]; // 0 representa espaço vazio
        ...
        {
            InitializeComponent();
            // Mapear os botões na grade (5x5)
            buttons = new Button[5, 5]
            {
                { Gamex1y1, Btnx2y1, Btnx3y1, Btnx4y1, Btnx5y1 },
                { Btnx1y2, Btnx2y2, Btnx3y2, Btnx4y2, Btnx5y2 },
                { Btnx1y3, Btnx2y3, Btnx3y3, Btnx4y3, Btnx5y3 },
                { Btnx1y4, Btnx2y4, Btnx3y4, Btnx4y4, Btnx5y4 },
                { Btnx1y5, Btnx2y5, Btnx3y5, Btnx4y5, Btnx5y5 }
            };
        ...
        private void GerarTabuleiroSolucionavel()
        {
            ...
            do
            {
                nums = Enumerable.Range(1, 24).ToList();
                // Embaralhar
        ...
        private bool EhSolucionavel(List<int> arr)
        {
            ...
            // Para largura ímpar (5), solucionável se inversões for par
